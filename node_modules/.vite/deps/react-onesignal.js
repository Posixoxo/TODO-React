//#region node_modules/react-onesignal/dist/index.js
var u = "onesignal-sdk", l = "https://cdn.onesignal.com/sdks/web/v16/OneSignalSDK.page.js";
var d = !1, s = !1;
...
function O(n, e) {
	return new Promise((i, r) => {
		var t;
		if (s) {
			r(/* @__PURE__ */ new Error("OneSignal script failed to load."));
			return;
		}
		(t = window.OneSignalDeferred) == null || t.push((o) => {
...
function v() {
	return new Promise((n, e) => {
		var i;
		if (s) {
			e(/* @__PURE__ */ new Error("OneSignal script failed to load."));
			return;
		}
...
function E(n) {
	return new Promise((e, i) => {
		var r;
		if (s) {
			i(/* @__PURE__ */ new Error("OneSignal script failed to load."));
			return;
		}
